              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter the details of the category</p>
                  </div>
                  <form class="row g-3 needs-validation" novalidate action="/TheFinalPOS/AddCategory?action=edit" method="post">
                    <input value="${loggedId}" name="loggedUserId" style="visibility: collapse; position: absolute" />
                      <input value="${category.getId()}" name="categoryId" style="visibility: collapse; position: absolute" />
                      <div class="col-12">
                      <label for="name" class="form-label">Name</label>
                      <input type="text" value="${category.getCategory()}" name="name" class="form-control" id="name" required>
