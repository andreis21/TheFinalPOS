            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate action="/TheFinalPOS/AddCategory" method="post">
                    <input name="loggedUserId" value="${loggedUser.getId()}" style="visibility: collapse; position: absolute"/>
                    <div class="col-12">
